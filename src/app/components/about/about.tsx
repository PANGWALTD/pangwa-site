    ...
    return (<div className="text-black">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 p-6 bg-gray-50 rounded-lg text-black">
            ...
            <div className="shadow-lg p-6 flex flex-col items-center text-center bg-white rounded-lg transition-transform transform hover:scale-105">
                <Image preview={false} src="./mission.png" width={100} preview={false} />
            ...
            {/* Vision */}
            <div className="shadow-lg p-6 flex flex-col items-center text-center bg-white rounded-lg transition-transform transform hover:scale-105">
                <Image preview={false} src="./vision.png" width={100} preview={false} />
            ...
            {/* Story */}
            <div className="shadow-lg p-6 flex flex-col items-center text-center bg-white rounded-lg transition-transform transform hover:scale-105">
                <Image preview={false} src="./story.png" width={100} preview={false} />
            ...
            {/* Values */}
            <div className="shadow-lg p-6 flex flex-col items-center text-center bg-white rounded-lg transition-transform transform hover:scale-105">
                <Image preview={false} src="./values.png" width={100} preview={false} />
