        ...
        <div className="py-12">
            <div className="container mx-auto">
                ...
                <div className="flex flex-col md:flex-row md:space-x-5 space-y-5 justify-center items-center">
                    ...
                    {/* Team Member 1 */}
                    <div className="shadow-lg p-8 flex flex-col items-center  text-center bg-white rounded-lg transition-transform transform hover:scale-105 hover:shadow-2xl hover:bg-gray-50 max-w-[600px]">
                        <img src="./lady.png" alt="Queenie Taylor Wong" className="w-36 h-36 rounded-full object-cover" />
                    ...
                    {/* Team Member 2 */}
                    <div className="shadow-lg p-8 flex flex-col items-center text-center bg-white rounded-lg transition-transform transform hover:scale-105 hover:shadow-2xl hover:bg-gray-50 max-w-[600px]">
                        <img src="./gentleman1.jpeg" alt="Wesley Onyango Ogada" className="w-36 h-36 rounded-full object-cover" />
